        ...
        <div class="tab-content p-a-0">
          <div id="comments" class="ps-block tab-pane fade in active" style="height: 300px">
            <div class="widget-comments-item">
              <img src="${ctxRoot}/assets/admin/dist/demo/avatars/5.jpg" alt="" class="widget-comments-avatar">
            ...
            <div class="widget-comments-item">
              <img src="${ctxRoot}/assets/admin/dist/demo/avatars/3.jpg" alt="" class="widget-comments-avatar">
              <div class="widget-comments-header">
            ...
            <div class="widget-comments-item">
              <img src="${ctxRoot}/assets/admin/dist/demo/avatars/2.jpg" alt="" class="widget-comments-avatar">
              <div class="widget-comments-header">
            ...
            <div class="widget-comments-item">
              <img src="${ctxRoot}/assets/admin/dist/demo/avatars/4.jpg" alt="" class="widget-comments-avatar">
              <div class="widget-comments-header">
          ...
          <div id="threads" class="ps-block tab-pane fade" style="height: 300px">
            <div class="widget-threads-item">
              <img src="${ctxRoot}/assets/admin/dist/demo/avatars/2.jpg" alt="" class="widget-threads-avatar">
            ...
            <div class="widget-threads-item">
              <img src="${ctxRoot}/assets/admin/dist/demo/avatars/3.jpg" alt="" class="widget-threads-avatar">
              <span class="widget-threads-date">14h</span>
              <a href="#" class="widget-threads-title">Lorem ipsum dolor sit amet</a>
            ...
            <div class="widget-threads-item">
              <img src="${ctxRoot}/assets/admin/dist/demo/avatars/4.jpg" alt="" class="widget-threads-avatar">
              <span class="widget-threads-date">14h</span>
              <a href="#" class="widget-threads-title">Lorem ipsum dolor sit amet</a>
            ...
            <div class="widget-threads-item">
              <img src="${ctxRoot}/assets/admin/dist/demo/avatars/5.jpg" alt="" class="widget-threads-avatar">
              <span class="widget-threads-date">14h</span>
              <a href="#" class="widget-threads-title">Lorem ipsum dolor sit amet</a>
        ...
        <div class="table-responsive">
          <table class="table">
            ...
            <tr>
              <td>1</td>
              <td>
                <img src="${ctxRoot}/assets/admin/dist/demo/avatars/2.jpg" alt="" style="width:26px;height:26px;" class="border-round">&nbsp;&nbsp;<a href="#" title="">@rjang</a>
              </td>
              <td>Robert Jang</td>
            ...
            <tr>
              <td>2</td>
              <td>
                <img src="${ctxRoot}/assets/admin/dist/demo/avatars/3.jpg" alt="" style="width:26px;height:26px;" class="border-round">&nbsp;&nbsp;<a href="#" title="">@mbortz</a>
              </td>
            ...
            <tr>
              <td>3</td>
              <td>
                <img src="${ctxRoot}/assets/admin/dist/demo/avatars/4.jpg" alt="" style="width:26px;height:26px;" class="border-round">&nbsp;&nbsp;<a href="#" title="">@towens</a>
              </td>
              <td>Timothy Owens</td>
            ...
            <tr>
              <td>4</td>
              <td>
                <img src="${ctxRoot}/assets/admin/dist/demo/avatars/5.jpg" alt="" style="width:26px;height:26px;" class="border-round">&nbsp;&nbsp;<a href="#" title="">@dsteiner</a>
              </td>
