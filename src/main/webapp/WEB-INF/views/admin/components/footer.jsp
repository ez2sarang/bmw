  ...
  <footer class="px-footer px-footer-bottom p-t-0" id="px-demo-footer">
    <div class="box m-a-0 bg-transparent">
      ...
      <div class="box-cell col-md-3 p-t-3 valign-middle">
        <a href="#" class="display-block m-b-1 text-nowrap"><i class="fa fa-twitter"></i>&nbsp;&nbsp;@ez2sarang</a>
        <a href="#" class="display-block m-b-1 text-nowrap"><i class="fa fa-facebook"></i>&nbsp;&nbsp;fcsoft</a>
        <a href="#" class="display-block text-nowrap"><i class="fa fa-envelope"></i>&nbsp;&nbsp;ez2sarang@gmail.com</a>
      </div>
    </div>

    <hr class="page-wide-block">

    <span class="text-muted">Copyright © 2017 IMPD Admin LLC. All rights reserved.</span>
  </footer>