(function(root, factory) {
  ...
  try {
    if(ctxRoot==undefined) {
      //$('body').append('<script>ctxRoot="";</script>');
      document.write('<script>ctxRoot="/impd";</script>');
    }
  } catch(e) {
    try {
      document.write('<script>ctxRoot="/impd";</script>');
  ...
  var locationDir = [locationParts.length - 2];
  var DIST_PATH = locationDir === 'docs' || locationDir === 'color-generator' ? '..' : '../..';
  DIST_PATH = "";
  ...
  var pxDemo = (function() {
    ...
    var BACKGROUNDS = [
      DIST_PATH + ctxRoot+'/assets/admin/dist/demo/bgs/1.jpg',
      DIST_PATH + ctxRoot+'/assets/admin/dist/demo/bgs/2.jpg',
      DIST_PATH + ctxRoot+'/assets/admin/dist/demo/bgs/3.jpg',
      DIST_PATH + ctxRoot+'/assets/admin/dist/demo/bgs/4.jpg',
      DIST_PATH + ctxRoot+'/assets/admin/dist/demo/bgs/5.jpg',
      DIST_PATH + ctxRoot+'/assets/admin/dist/demo/bgs/6.jpg',
      DIST_PATH + ctxRoot+'/assets/admin/dist/demo/bgs/7.jpg',
      DIST_PATH + ctxRoot+'/assets/admin/dist/demo/bgs/8.jpg',
      DIST_PATH + ctxRoot+'/assets/admin/dist/demo/bgs/9.jpg',
    ];
    ...
    function setTheme(themeName) {
      ...
      var themePath = DIST_PATH + '/dist/css/themes/' + themeName + (_isRtl ? '.rtl' : '') + '.min.css';
    ...
    function initializeDemoSidebar() {
      ...
      sidebarEl.innerHTML   = '<a href="#" id="px-demo-sidebar-toggle" class="bg-primary b-y-1 b-l-1 text-default" data-toggle="sidebar" data-target="#px-demo-sidebar"><i class="ion-ios-gear"></i><i class="ion-android-close"></i></a><div id="px-demo-sidebar-loader" class="form-loading form-loading-inverted"></div>';
      ...
      for (var i = 0, l = THEMES.length; i < l; i++) {
        content += '<label class="px-demo-themes-item">';
          ...
          content += '<img src="' + DIST_PATH +ctxRoot+'/assets/admin/dist/demo/themes/' + THEMES[i] + '.png" class="px-demo-themes-thumbnail">';
