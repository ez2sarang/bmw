...
import org.mariapresso.impd.interceptor.SetLocaleInterceptor;
import org.mariapresso.util.ApplicationContextProvider;
...
@EnableWebMvc
@ComponentScan(basePackages = { "org.mariapresso", "np.com.mshrestha.dropzonetest" }, useDefaultFilters = false, includeFilters = { @ComponentScan.Filter(type = FilterType.ANNOTATION, value = org.springframework.stereotype.Controller.class) })
@PropertySource("file:${catalina.home}/conf/impd/config.properties")
...
//	ServletContext servletContext;
	...
	public MessageSource messageSource() {
		...
		bundle.setBasenames(new String[] {
				"classpath:/org/mariapresso/impd/i18n/messages",
				"classpath:/org/mariapresso/impd/i18n/labels" });
	...
	public WebMvcConfigurerAdapter webMvcConfigurerAdapter() {
		return new WebMvcConfigurerAdapter() {
			...
			public void addInterceptors(final InterceptorRegistry registry) {
				registry.addInterceptor(new SetLocaleInterceptor(resolver)).addPathPatterns("/login**");
